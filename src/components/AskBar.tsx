...
export default function AskBar({ credits }: { credits: number }) {
    ...
    <div className="rounded-2xl border border-brand-100 bg-gradient-to-br from-brand-50/70 to-accent-50/40 p-4 sm:p-6 shadow-sm">
      {outOfCredits ? (
        <p className="text-sm text-gray-700">
          You're out of ask credits for now. Respond to a request on the{" "}
          <a href="/feed" className="text-brand-700 font-medium hover:underline">
            community feed
          </a>{" "}
          or help someone who's already asked — that earns you more. You'll also get a small
          refresh next month.
        </p>
      ) : (
        <>
